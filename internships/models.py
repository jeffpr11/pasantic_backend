...
class Internship(BaseModel):
    ...
    typeOfWorkDay = models.CharField(max_length=15)
    ...
    endDate = models.DateField(auto_now=False, blank=True, null=True)
    durationMonths = models.IntegerField(max_length=2)
    remuneration = models.DecimalField(max_digits= 6, decimal_places=3)
    haveRemuneration = models.BooleanField(default=False)
...
class Postulation(BaseModel):
    postDate = models.DateField(auto_now=True, null=True)
